  ...
  return (
    <section id="home" className="grid-bg pt-40 pb-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        {/* Left text (Scroll Animation Integrated) */}
        <motion.div
        ...
        >
          <span className="inline-block text-xs tracking-widest text-primary border border-primary/40 rounded-full px-4 py-1.5 mb-6">
          ...
          <div className="flex gap-4 mb-10">
            <a href="#contact" className="bg-brand-gradient px-6 py-3 rounded-full font-semibold transition-transform hover:scale-105 active:scale-95">
              Get Started →
            </a>
            <a href="#case-study" className="border border-border px-6 py-3 rounded-full font-semibold transition-all hover:bg-white/5">
              ▷ See Case Study
            </a>
          </div>
        ...
        {/* Right orbit visual (With Animation and Glow Upgrades) */}
        <motion.div 
        ...
        >
          ...
          {/* Center Logo with Custom Glow Effect */}
          <div className="w-24 h-24 rounded-2xl bg-brand-gradient flex items-center justify-center font-bold z-10 shadow-[0_0_40px_rgba(124,58,237,0.5)]">
          ...
          {/* Badges popping up smoothly */}
          {orbitBadges.map((b) => (
            <motion.span
              key={b.label}
              className={`absolute ${b.pos} glass text-xs px-3 py-1.5 rounded-full border border-border/60 shadow-lg`}
